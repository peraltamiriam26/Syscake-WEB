<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
    <div class="relative p-5 border w-96 shadow-lg rounded-md bg-white">
        ...
        <div class="flex justify-end mt-6">
            ...
            {{-- ¡¡¡CORRECCIÓN AQUÍ!!! Cambiado a type="button" y wire:click directo --}}
            <button type="button" wire:click="addIngredientToRecipe" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                Aceptar
            </button>
        </div>
        {{-- ¡¡¡ELIMINADO EL TAG </form> DE AQUÍ!!! --}}
