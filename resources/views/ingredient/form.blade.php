    ...
    <div class="card-body flex items-center">
        ...
        @csrf
                ...
                <div class="grid grid-flow-col justify-items-left">
                    <div class="me-2">
                        @if (isset($ingredient->id))
                            <input type="text" name="id" value="{{ old('id', $ingredient->id) }}" class="input"  id="id" hidden/>
                        @endif
                    <label class="label-text">Nombre</label>
                    <input type="text" name="nombre" placeholder="Nombre" value="{{ old('nombre', $ingredient->nombre) }}" class="input @error('nombre') is-invalid @enderror"  id="nombreUsuario" autofocus/>
                    @error('nombre')
            ...
            <div class="grid grid-flow-col pt-2">
                ...
                <a type="button" class="btn btn-primary btn-outline justify-items-left items-left-safe rounded-full w-50" href="{{ route('index-ingredients') }}">Cancelar</a>  
                </div>
                <div class="grid grid-flow-col justify-items-center">
