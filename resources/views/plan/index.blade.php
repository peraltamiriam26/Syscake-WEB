                    ...
                    @foreach  ($plans as $plan)
                        <tr>
                            ...
                            <td>
                                ...
                                <a id="btnDelete"  aria-label="Action button" onclick="alertDelete('delete-plan/{{$plan->id}}', '¿Desea eliminar el plan del día {{$plan->fecha}}?');" class="btn btn-circle btn-text btn-sm" href="#">
