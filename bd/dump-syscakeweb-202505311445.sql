...
--
-- Host: localhost    Database: syscakeweb
-- ------------------------------------------------------
...
CREATE TABLE `tipounidads` (
  ...
  CONSTRAINT `tipounidads_ingredientes_FK` FOREIGN KEY (`ingrediente_id`) REFERENCES `ingredientes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-05-31 14:45:30
