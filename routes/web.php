...
Route::middleware(['auth'])->group(function () {    
    ...
    Route::middleware(['auth', 'can:es-escritor'])->group(function () {
        // Solo usuarios autenticados con permiso 'es-escritor'
        /** INGREDIENTES */
    ...
    Route::get('/recipe/{id}/download', [RecetasController::class, 'downloadInvoice'])->name('recipe.descargar');
